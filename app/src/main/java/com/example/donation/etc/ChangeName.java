...
public class ChangeName extends AppCompat{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        edt1 = (EditText) findViewById(R.id.change_name_edt1);  // 이름
        btn1 = (Button) findViewById(R.id.change_name_btn1);    // 변경 확인 버튼
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(account != null){
                    edt1.setText(account.getUserName());
                }
            }
            @Override
        ...
        // 뒤로 가기 버튼
        ch_na_back = (ImageView) findViewById(R.id.change_name_tb_btn);
